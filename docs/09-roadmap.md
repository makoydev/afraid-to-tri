...
_Built first and in isolation, because it's the highest-risk and highest-value part, and it has no UI dependencies._
...
_The riskiest UI work. Budget for it to overrun._
...
- [ ] Garmin: activity import **and workout push to watch** ([F-20](01-product-spec.md#f-20--garmin-connect-integration--p1)) — _apply to the partner program in Phase 1, approval is the long pole_
