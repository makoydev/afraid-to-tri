...
- Every session ships a plain-language cue: *"Comfortable — you could hold a conversation."*
...
- Once a test exists, numeric targets appear *alongside* the cue, never instead of it.
