...
The underlying science is not proprietary — Banister's impulse–response model dates to 1975, Foster's session-RPE to the late 1990s, and exponentially-weighted moving averages are just arithmetic. But the _names_ are protected, and using them in a commercial product invites a trademark problem we have no interest in.
